...
More information and examples can be found in Spikee's documentation and codebase: [Multi-Turn Targets](../06_custom_targets.md#multi-turn-dynamic-targets), [Example SimpleMultiTarget](../../spikee/data/workspace/targets/sample_simple_chatbot.py), and [Example MultiTarget](../../spikee/data/workspace/targets/sample_chatbot.py).
